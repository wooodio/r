...
def ocr_core(image):
    ...
    checkpoint = load_checkpoint("C:\\Users\PC4\Desktop\DL\p4-ocr-hansarang\demo\log\satrn\checkpoints\\0050.pth", cuda=is_cuda)
    ...
    file_path = 'C:\\Users\PC4\Desktop\DL\p4-ocr-hansarang\input\data\eval_dataset\input.txt'
